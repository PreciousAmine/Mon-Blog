...
@section('content-id')
<!-- ======= Breadcrumbs ======= -->
<div class="breadcrumbs s-hero_slider d-flex align-items-center" style="background-image: url({{ asset('images/hi-bg.jpg') }}), url({{ asset('images/hi-bg.jpg') }}), url({{ asset('images/blog-header.jpg') }});">
