...
<div class="breadcrumbs d-flex align-items-center" style="background-image: url({{ asset('images/blog-header.jpg') }});">
  <div class="container position-relative d-flex flex-column align-items-center">
    ...
    <h2>Preview Poem</h2>
    <ol>
      <li><a href="{{ route('article.index') }}">Poem list</a></li>
      <li>{{ $post->title }}</li>
    </ol>
            ...
            <ul>
              ...
              <li class="d-flex align-items-center">
                ...
                <a href="javascript:void(0)">
                  <time datetime="2024-01-01">{{ $post->created_at->format('M d, Y') }}</time>
                </a>
              </li>
              <li class="d-flex align-items-center">
          ...
          <h4 class="comments-count">0 Comments</h4>
            <div id="comment-1" class="comment">
              <div class="d-flex">
                ...
                <div>
                  <h5><a href="javascript:void(0)">Goody Precious</a></h5>
                  <time datetime="2020-01-01">04 Apr, 2024</time>
                  <p>
                    Preview comment
                  </p>
                </div>
