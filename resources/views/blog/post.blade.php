        ...
        <article class="blog-details">
          ...
          <div class="meta-bottom">
            ...
            <ul class="tags">
              ...
              @else
                <li>
                  <a href="javascript:void(0)">No tags yet.</a>
                </li>
              @endif
							<li>
							<a href="{{ route('like.post', $post->id) }}"
   class="{{ $post->liked() ? 'active' : '' }} bi bi-hand-thumbs-up"
            ...
            <div id="comment-1" class="comment">
              <div class="d-flex">
                ...
                <div>
                  ...
                  <time datetime="2024-01-01">{{ $comment->created_at->format('M d, Y') }}</time>
                  <p>
                    {{ $comment->content }}
                  </p>
                </div>
              ...
              <form action="{{ route('store-comment', $post->slug) }}#comment-section" method="POST" id="comment-section">
                ...
                <div class="row">
                  <div class="col form-group">
                    <textarea name="content" class="form-control" placeholder="Your Comment, your feelings about what you'are reading" rows="6" {{ $disabledForm }}></textarea>
                ...
                <button type="submit" class="btn btn-primary" {{ $disabledForm }}>Poem Comment</button>
              </form>
            @endauth
          </div>
        </div>
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="sidebar ps-lg-4">
          ...
          <div class="sidebar-item recent-posts">
            <h3 class="sidebar-title">Related Poems</h3>
                ...
                @if ($relatedPost->active == 1)
                  <div class="post-item">
                    ...
                    <div>
                      ...
                      <time datetime="2024-01-01">{{ $relatedPost->created_at->format('M d, Y') }}</time>
                    </div>
                  </div>
                @endif
              @endforeach
