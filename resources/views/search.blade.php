                ...
                <article class="d-flex flex-column">
                  ...
                  <div class="meta-top">
                    <ul>
                      ...
                      <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="{{ route('post', $result->slug) }}"><time datetime="2024-01-01">{{ $result->created_at->format('M d, Y') }}</time></a></li>
